...
RegisterNUICallback('closeMenu', function(data, cb)         -- closeMenu callbackini dinler ve işler | function dan sonra () koyma nedenimiz callbackinidan gelen veriyi almak için 
...
RegisterNUICallback('selectOption', function(data, cb)      -- selectOption callbackini dinler ve işler | function dan sonra () koymazsak callbackinidan gelen veriyi alamayız
